...
const pb = __webpack_require__(7);
...
// expose via underscore for debugging purposes
...
/* WEBPACK VAR INJECTION */(function(process, __dirname) {const tensorjs = __webpack_require__(15);
const image_ops = __webpack_require__(11);
...
TFJS.for_node = function (path_for_dir) {
  ...
  const graph_runner = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND';; throw e; }());
  process.chdir(cwd);
...
var tensor_shape_pb = __webpack_require__(8);
var types_pb = __webpack_require__(9);
...
var tensor_shape_pb = __webpack_require__(13);
var types_pb = __webpack_require__(14);
goog.exportSymbol('proto.tensorflow.TensorProto', null, global);
...
const pb = __webpack_require__(12);
const _ = __webpack_require__(1);
...
var _tensorjs = __webpack_require__(4);

var _tensorjs2 = _interopRequireDefault(_tensorjs);

var _tfjs = __webpack_require__(5);
...
self._lib = undefined; /* global onMessage:true, postMessage:true */
...
_tfjs2.default.for_web_worker('/tensorflowjs/').then(function (lib) {
  self._lib = lib;
  return (0, _utils.loadGraphAsArrayBuffer)("/graphs/inception.stripped.pb");
}).then(function (graph) {
